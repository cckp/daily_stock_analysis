  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'primary-gradient': 'linear-gradient(135deg, #8b78e6 0%, #6450c8 100%)',
      },
      boxShadow: {
        'soft-card': 'var(--shadow-soft-card)',
        'soft-card-strong': 'var(--shadow-soft-card-strong)',
        'glow-cyan': '0 0 20px rgba(139, 120, 230, 0.4)',
        'glow-purple': '0 0 20px rgba(168, 85, 247, 0.3)',
        'glow-success': '0 0 20px rgba(0, 255, 136, 0.3)',
        'glow-danger': '0 0 20px rgba(255, 68, 102, 0.3)',
        'cyan/20': '0 12px 28px rgba(139, 120, 230, 0.2)',
        'cyan/22': '0 18px 34px rgba(139, 120, 230, 0.22)',
      },
      borderRadius: {
        lg: 'var(--radius)',
      ...
      keyframes: {
        ...
        pulseGlow: {
          '0%, 100%': { boxShadow: '0 0 20px rgba(139, 120, 230, 0.4)' },
          '50%': { boxShadow: '0 0 40px rgba(139, 120, 230, 0.6)' },
        },
      },
    },
  },
